...
import { FORGE_CHANNEL_NAME } from '../../workbench/contrib/void/common/forge/contracts/forgeIPC.js';
import { createForgeIPCChannel } from '../../workbench/contrib/void/electron-main/forge/ipc/forgeChannel.js';
/**
...
export class CodeApplication extends Disposable {
	...
	private initChannels(accessor: ServicesAccessor, mainProcessElectronServer: ElectronIPCServer, sharedProcessClient: Promise<MessagePortClient>): void {
		...
		// Forge channel
		const forgeChannel = createForgeIPCChannel();
		mainProcessElectronServer.registerChannel(FORGE_CHANNEL_NAME, forgeChannel);
