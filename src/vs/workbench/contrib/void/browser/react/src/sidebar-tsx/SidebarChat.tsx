...
export const ButtonSubmit = ({ className, disabled, ...props }: ButtonProps & Required<Pick<ButtonProps, 'disabled'>>) => {
	...
	return <button
		type='button'
		className={`rounded-lg p-1.5 flex-shrink-0 flex-grow-0 flex items-center justify-center transition-all
			${disabled ? 'bg-emerald-800/40 text-emerald-300/40 cursor-default' : 'bg-emerald-600 hover:bg-emerald-500 text-white cursor-pointer shadow-md'}
			${className || ''}
		`}
		{...props}
	>
				...
				{isCommitted && (
					<div className="flex items-center justify-between mt-3 pt-2 border-t border-zinc-800/60 text-xs text-zinc-400">
						...
						<div className="flex items-center gap-1 text-zinc-400">
							<button type="button" className="p-1 hover:text-zinc-200 hover:bg-zinc-800 rounded transition-colors" title="Like"><ThumbsUp size={14} /></button>
							<button type="button" className="p-1 hover:text-zinc-200 hover:bg-zinc-800 rounded transition-colors" title="Dislike"><ThumbsDown size={14} /></button>
							<button type="button" className="p-1 hover:text-zinc-200 hover:bg-zinc-800 rounded transition-colors" title="Copy response"><CopyIcon size={14} /></button>
							<button type="button" className="p-1 hover:text-zinc-200 hover:bg-zinc-800 rounded transition-colors" title="Fork / Branch thread"><GitFork size={14} /></button>
						</div>
					</div>
				)}
			</div>
