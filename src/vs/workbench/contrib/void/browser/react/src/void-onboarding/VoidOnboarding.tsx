...
const providerNamesOfTab: Record<TabName, ProviderName[]> = {
	Free: ['gemini', 'openRouter', 'nvidia'],
	Local: localProviderNames,
	Paid: providerNames.filter(pn => !(['gemini', 'openRouter', 'nvidia', ...localProviderNames, ...cloudProviders] as string[]).includes(pn)) as ProviderName[],
...
const VoidOnboardingContent = () => {
	...
	const lastPagePrevAndNextButtons = <div className="max-w-[600px] w-full mx-auto flex flex-col items-end">
		<div className="flex items-center gap-2">
			...
			>Enter Forge AI</PrimaryActionButton>
		</div>
	</div>
		...
		0: <OnboardingPageShell
			content={
				<div className='flex flex-col items-center gap-8'>
					<div className="text-5xl font-light text-center">Welcome to Forge AI</div>
