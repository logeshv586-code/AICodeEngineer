	...
	return (
		<div className='forge-brand-composer-shell shrink-0' onDragOver={event => event.preventDefault()} onDrop={handleDrop}>
			...
			<div className='forge-brand-composer'>
				{(workspaceReady || selectedFiles.length > 0 || attachments.length > 0 || providerName || contextPercent !== null) && <div className='flex items-center gap-1.5 px-3 pt-2.5 flex-wrap'>
