...
export const runUiContractTest = () => {
  ...
  const checks = [
    ...
    check('dark slash palette contract', contains(files.slashRouter, ['forge-slash-overlay', 'forge-slash-palette', 'forge-slash-command-selected', "role='dialog'", "aria-label='Forge slash commands'"]) && contains(files.brandCss, ['z-index: 99999', '--vscode-quickInput-background']), 'The portal-based slash palette must use explicit Forge hooks and editor theme tokens instead of browser-default white controls'),
