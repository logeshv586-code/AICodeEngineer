...
const checks = [
  ...
  ['Windows setup can auto-repair Spectre prerequisites', setup.includes('forge-windows-spectre-ensure.ps1') && spectreEnsure.includes("'modify', '--installPath'") && spectreEnsure.includes("'--add', $component") && spectreEnsure.includes('-Verb RunAs') && spectreEnsure.includes("'--passive', '--norestart'") && spectreEnsure.includes('Test-ForgeSpectreReady -Silent')],
